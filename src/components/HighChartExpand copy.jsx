...
export default function HighChartExpand (){
  ...
  let kospiArr_All = chartFunc.getReArrangeData(data) // 데이터 숫자 및 단위 정리
  let dataArr_All_Month = chartFunc.changeDateToMonth(kospiArr_All); //코스피 월간 전체 데이터 (2001 ~ 현재)
